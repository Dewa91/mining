...
echo ""
read -p "Masukan mata uang (monero or aeon): " -e etn
read -p "Masukan pool address (Example: pool.supportxmr.com:3333): " -e etn.fairhash.org:3333
read -p "Masukan wallet address: " -e etnkNz6Xc6WifzFh4A9zMHUTGrsnvUxtcN2ksXQjSoQK9AYEHFsmdqqh5ZBUbLK3m1Zt9FFdKPn5RMkdozuHj1EC1VV7n2jp2f
read -p "Masukan static diff jika ada jika tidak langsung enter(Example: 3000): " -e 2500
...
echo ""
read -p "Masukan core vps (1-6): " -e 1
read -p "Apakah anda ingin langsung menjalankan mining? [y/n]: " -e -i y mining
